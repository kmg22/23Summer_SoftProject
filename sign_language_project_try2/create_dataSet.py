...
os.makedirs('D:/python/sign_language_project_try2/dataset', exist_ok=True)
...
while cap.isOpened():
    for idx, action in enumerate(actions):
        ...
        myfont = ImageFont.truetype('D:/python/sign_language_project_try2/font/MaruBuri-Bold.ttf',20)
        org=(10,30)# 글자 표시할 위치
        ...
        np.save(os.path.join('D:/python/sign_language_project_try2/dataset', f'raw_{action}_{created_time}'), data)
        ...
        np.save(os.path.join('D:/python/sign_language_project_try2/dataset', f'seq_{action}_{created_time}'), full_seq_data)
    break